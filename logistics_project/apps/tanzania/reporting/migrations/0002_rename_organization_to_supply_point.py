...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('reporting_organizationsummary', 'organization_id', 'supply_point_id')
        db.rename_column('reporting_productavailabilitydata', 'organization_id', 'supply_point_id')
        db.rename_column('reporting_alert', 'organization_id', 'supply_point_id')
        
    def backwards(self, orm):
        db.rename_column('reporting_organizationsummary', 'supply_point_id', 'organization_id')
        db.rename_column('reporting_productavailabilitydata', 'supply_point_id', 'organization_id')
        db.rename_column('reporting_alert', 'supply_point_id', 'organization_id')
