...
#    (r'^doclist', 'ilsgateway.views.doclist'),
    ...
    url(r'^reports/randr/$', 'logistics_project.apps.tanzania.views.randr_report', name='randr_report'),
    url(r'^reports/soh/$', 'logistics_project.apps.tanzania.views.soh_report', name='soh_report'),
    url(r'^reports/delivery$', 'logistics_project.apps.tanzania.views.delivery_report', name='delivery_report'),
    url(r'^reports/supervision$', 'logistics_project.apps.tanzania.views.supervision_report', name='supervision_report'),
#    url(r'^reports/submission$', 'logistics_project.apps.tanzania.views.submission_report', name='submission_report'),
