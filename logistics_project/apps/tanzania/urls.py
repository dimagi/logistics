...
urlpatterns = patterns('',
    ...
    ('^facilities/$', 'logistics_project.apps.tanzania.views.facilities_index'),
...
#    url('^supervision', 'ilsgateway.views.supervision', name='supervision'),
    url('^reports/$', 'logistics_project.apps.tanzania.views.reporting', name='reports'),
    url(r'^reports/pdf/$', 'logistics_project.apps.tanzania.views.reporting_pdf', name="pdf_test"),
