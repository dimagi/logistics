...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ServiceDeliveryPoint', fields ['name']
        db.create_unique('ilsgateway_servicedeliverypoint', ['name'])

        # Adding field 'ServiceDeliveryPointProductReport.message'
        db.add_column('ilsgateway_servicedeliverypointproductreport', 'message', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['messagelog.Message']), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'ServiceDeliveryPoint', fields ['name']
        db.delete_unique('ilsgateway_servicedeliverypoint', ['name'])

        # Deleting field 'ServiceDeliveryPointProductReport.message'
        db.delete_column('ilsgateway_servicedeliverypointproductreport', 'message_id')
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 17, 10, 41, 49, 463000)', 'auto_now_add': 'True', 'blank': 'True'}),
