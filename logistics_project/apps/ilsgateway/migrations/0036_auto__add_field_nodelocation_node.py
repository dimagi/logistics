...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NodeLocation.node'
        db.add_column('ilsgateway_nodelocation', 'node', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.Node'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NodeLocation.node'
        db.delete_column('ilsgateway_nodelocation', 'node_id')
    ...
    models = {
        ...
        'ilsgateway.nodelocation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'node': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.Node']", 'null': 'True', 'blank': 'True'}),
        ...
        'ilsgateway.nodeproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 2, 20, 20, 17, 88000)', 'auto_now_add': 'True', 'blank': 'True'}),
