...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NodeType.parent_node_type'
        db.add_column('ilsgateway_nodetype', 'parent_node_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.NodeType'], null=True, blank=True), keep_default=False)

        # Adding field 'Node.parent_node'
        db.add_column('ilsgateway_node', 'parent_node', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.Node'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NodeType.parent_node_type'
        db.delete_column('ilsgateway_nodetype', 'parent_node_type_id')

        # Deleting field 'Node.parent_node'
        db.delete_column('ilsgateway_node', 'parent_node_id')
    ...
    models = {
        ...
        'ilsgateway.nodeproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 1, 11, 36, 42, 121000)', 'auto_now_add': 'True', 'blank': 'True'}),
