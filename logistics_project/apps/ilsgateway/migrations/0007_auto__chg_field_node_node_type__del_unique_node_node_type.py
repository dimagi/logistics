...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Node', fields ['node_type']
        db.delete_unique('ilsgateway_node', ['node_type_id'])

        # Changing field 'Node.node_type'
        db.alter_column('ilsgateway_node', 'node_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.NodeType'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Node.node_type'
        db.alter_column('ilsgateway_node', 'node_type_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ilsgateway.NodeType'], unique=True, null=True))

        # Adding unique constraint on 'Node', fields ['node_type']
        db.create_unique('ilsgateway_node', ['node_type_id'])
