...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ilsgateway_node', 'node_type', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ilsgateway.NodeType'], unique=True, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('ilsgateway_facility', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.District'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Point'], null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.delete_column('ilsgateway_node', 'node_type_id')
    ...
    models = {
        ...
        'ilsgateway.node': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'node_type': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['ilsgateway.NodeType']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'ilsgateway.nodetype': {
