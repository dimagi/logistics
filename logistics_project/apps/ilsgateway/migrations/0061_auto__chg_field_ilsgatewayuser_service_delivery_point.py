...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ILSGatewayUser.service_delivery_point'
        db.alter_column('ilsgateway_ilsgatewayuser', 'service_delivery_point_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.ServiceDeliveryPoint']))


    def backwards(self, orm):
        
        # Changing field 'ILSGatewayUser.service_delivery_point'
        db.alter_column('ilsgateway_ilsgatewayuser', 'service_delivery_point_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.ServiceDeliveryPoint'], null=True))
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointdgreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 18, 15, 15, 56, 910344)', 'auto_now_add': 'True', 'blank': 'True'}),
            'service_delivery_point': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.ServiceDeliveryPoint']"})
        },
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.Product']"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {}),
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 18, 15, 15, 56, 909348)', 'auto_now_add': 'True', 'blank': 'True'}),
