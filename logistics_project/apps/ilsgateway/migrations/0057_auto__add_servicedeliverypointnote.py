...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ServiceDeliveryPointNote'
        db.create_table('ilsgateway_servicedeliverypointnote', (
            ...
            ('contact_detail', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.ContactDetail'])),
        ))
        db.send_create_signal('ilsgateway', ['ServiceDeliveryPointNote'])


    def backwards(self, orm):
        
        # Deleting model 'ServiceDeliveryPointNote'
        db.delete_table('ilsgateway_servicedeliverypointnote')
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointdgreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 4, 20, 25, 19, 209000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'service_delivery_point': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.ServiceDeliveryPoint']"})
        },
