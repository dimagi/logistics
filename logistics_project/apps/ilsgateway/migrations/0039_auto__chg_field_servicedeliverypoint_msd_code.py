...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceDeliveryPoint.msd_code'
        db.alter_column('ilsgateway_servicedeliverypoint', 'msd_code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'ServiceDeliveryPoint.msd_code'
        db.alter_column('ilsgateway_servicedeliverypoint', 'msd_code', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 8, 15, 56, 32, 140000)', 'auto_now_add': 'True', 'blank': 'True'}),
