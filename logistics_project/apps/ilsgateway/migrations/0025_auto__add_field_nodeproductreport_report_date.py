...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NodeProductReport.report_date'
        db.add_column('ilsgateway_nodeproductreport', 'report_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 8, 30, 11, 9, 59, 292000), auto_now_add=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NodeProductReport.report_date'
        db.delete_column('ilsgateway_nodeproductreport', 'report_date')
    ...
    models = {
        ...
        'ilsgateway.nodeproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 30, 11, 9, 59, 292000)', 'auto_now_add': 'True', 'blank': 'True'}),
