...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ILSGatewayUser.role'
        db.add_column('ilsgateway_ilsgatewayuser', 'role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.ContactRole'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ILSGatewayUser.role'
        db.delete_column('ilsgateway_ilsgatewayuser', 'role_id')
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointdgreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 18, 13, 44, 40, 180301)', 'auto_now_add': 'True', 'blank': 'True'}),
            'service_delivery_point': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.ServiceDeliveryPoint']"})
        },
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.Product']"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {}),
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 18, 13, 44, 40, 179342)', 'auto_now_add': 'True', 'blank': 'True'}),
