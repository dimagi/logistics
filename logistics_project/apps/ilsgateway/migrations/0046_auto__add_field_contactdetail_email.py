...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactDetail.email'
        db.add_column('ilsgateway_contactdetail', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactDetail.email'
        db.delete_column('ilsgateway_contactdetail', 'email')
    ...
    models = {
        ...
        'ilsgateway.districtlocation': {
            'Meta': {'ordering': "('service_delivery_point__name',)", 'object_name': 'DistrictLocation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ilsgateway.facilitylocation': {
            'Meta': {'ordering': "('service_delivery_point__name',)", 'object_name': 'FacilityLocation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'parent_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
            'point': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['locations.Point']", 'null': 'True', 'blank': 'True'}),
        ...
        'ilsgateway.regionlocation': {
            'Meta': {'ordering': "('service_delivery_point__name',)", 'object_name': 'RegionLocation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'parent_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
            'point': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['locations.Point']", 'null': 'True', 'blank': 'True'}),
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 29, 18, 12, 44, 797000)', 'auto_now_add': 'True', 'blank': 'True'}),
