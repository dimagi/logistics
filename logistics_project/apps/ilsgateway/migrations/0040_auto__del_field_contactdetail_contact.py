...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # We cannot add back in field 'ContactDetail.contact'
        raise RuntimeError(
            "Cannot reverse this migration. 'ContactDetail.contact' and its values cannot be restored.")
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 8, 16, 42, 58, 724000)', 'auto_now_add': 'True', 'blank': 'True'}),
