...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NodeProductReport.message'
        db.add_column('ilsgateway_nodeproductreport', 'message', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['messagelog.Message']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NodeProductReport.message'
        db.delete_column('ilsgateway_nodeproductreport', 'message_id')
