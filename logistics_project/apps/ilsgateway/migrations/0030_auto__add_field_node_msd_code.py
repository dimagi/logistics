...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.msd_code'
        db.add_column('ilsgateway_node', 'msd_code', self.gf('django.db.models.fields.CharField')(default=0, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.msd_code'
        db.delete_column('ilsgateway_node', 'msd_code')
    ...
    models = {
        ...
        'ilsgateway.nodeproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 1, 11, 46, 44, 492000)', 'auto_now_add': 'True', 'blank': 'True'}),
