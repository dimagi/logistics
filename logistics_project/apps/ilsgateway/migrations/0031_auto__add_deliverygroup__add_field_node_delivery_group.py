...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ilsgateway_deliverygroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('ilsgateway', ['DeliveryGroup'])

        # Adding field 'Node.delivery_group'
        db.add_column('ilsgateway_node', 'delivery_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.DeliveryGroup'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'DeliveryGroup'
        db.delete_table('ilsgateway_deliverygroup')

        # Deleting field 'Node.delivery_group'
        db.delete_column('ilsgateway_node', 'delivery_group_id')
    ...
    models = {
        ...
        'ilsgateway.nodeproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 1, 22, 57, 1, 185000)', 'auto_now_add': 'True', 'blank': 'True'}),
