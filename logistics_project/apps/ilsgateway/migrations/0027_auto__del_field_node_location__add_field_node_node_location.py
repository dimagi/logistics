...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('ilsgateway_node', 'location_id')

        # Adding field 'Node.node_location'
        db.add_column('ilsgateway_node', 'node_location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.NodeLocation'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Node.location'
        db.add_column('ilsgateway_node', 'location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Point'], null=True, blank=True), keep_default=False)

        # Deleting field 'Node.node_location'
        db.delete_column('ilsgateway_node', 'node_location_id')
    ...
    models = {
        ...
        'ilsgateway.node': {
            ...
            'child_node': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'child_node_rel_+'", 'null': 'True', 'to': "orm['ilsgateway.Node']"}),
        ...
        'ilsgateway.nodeproductreport': {
            'Meta': {'object_name': 'NodeProductReport'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 1, 7, 2, 37, 159000)', 'auto_now_add': 'True', 'blank': 'True'}),
