...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NodeStatus.status_date'
        db.delete_column('ilsgateway_nodestatus', 'status_date')

        # Adding field 'NodeStatus.created_at'
        db.add_column('ilsgateway_nodestatus', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 8, 27), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'NodeStatus.status_date'
        db.add_column('ilsgateway_nodestatus', 'status_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2010, 8, 27)), keep_default=False)

        # Deleting field 'NodeStatus.created_at'
        db.delete_column('ilsgateway_nodestatus', 'created_at')
