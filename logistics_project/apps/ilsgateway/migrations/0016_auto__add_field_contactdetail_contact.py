...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactDetail.contact'
        db.add_column('ilsgateway_contactdetail', 'contact', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rapidsms.Contact']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactDetail.contact'
        db.delete_column('ilsgateway_contactdetail', 'contact_id')
