...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NodeStatusType.short_name'
        db.add_column('ilsgateway_nodestatustype', 'short_name', self.gf('django.db.models.fields.CharField')(default='none', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NodeStatusType.short_name'
        db.delete_column('ilsgateway_nodestatustype', 'short_name')
