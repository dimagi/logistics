...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'DeliveryGroup', fields ['name']
        db.create_unique('ilsgateway_deliverygroup', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'DeliveryGroup', fields ['name']
        db.delete_unique('ilsgateway_deliverygroup', ['name'])
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 21, 13, 3, 23, 789000)', 'auto_now_add': 'True', 'blank': 'True'}),
