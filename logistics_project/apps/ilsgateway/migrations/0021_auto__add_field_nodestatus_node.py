...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NodeStatus.node'
        db.add_column('ilsgateway_nodestatus', 'node', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ilsgateway.Node']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NodeStatus.node'
        db.delete_column('ilsgateway_nodestatus', 'node_id')
