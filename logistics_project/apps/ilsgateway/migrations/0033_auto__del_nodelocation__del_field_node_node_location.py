...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('ilsgateway_node', 'node_location', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ilsgateway.NodeLocation'], unique=True, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'ilsgateway.nodeproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 2, 20, 9, 1, 728000)', 'auto_now_add': 'True', 'blank': 'True'}),
