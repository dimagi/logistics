...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field managed_supply_points on 'Organization'
        db.create_table('malawi_organization_managed_supply_points', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm['malawi.organization'], null=False)),
            ('supplypoint', models.ForeignKey(orm['logistics.supplypoint'], null=False))
        ))
        db.create_unique('malawi_organization_managed_supply_points', ['organization_id', 'supplypoint_id'])

    def backwards(self, orm):
        # Removing M2M table for field managed_supply_points on 'Organization'
        db.delete_table('malawi_organization_managed_supply_points')
