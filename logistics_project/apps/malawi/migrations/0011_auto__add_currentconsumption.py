...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CurrentConsumption'
        db.create_table('malawi_currentconsumption', (
            ...
            ('current_daily_consumption', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('stock_on_hand', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
        ))
        db.send_create_signal('malawi', ['CurrentConsumption'])

    def backwards(self, orm):
        # Deleting model 'CurrentConsumption'
        db.delete_table('malawi_currentconsumption')
