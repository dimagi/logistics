...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoricalStock'
        db.create_table('malawi_historicalstock', (
            ...
            ('stock', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('total', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('malawi', ['HistoricalStock'])

    def backwards(self, orm):
        # Deleting model 'HistoricalStock'
        db.delete_table('malawi_historicalstock')
