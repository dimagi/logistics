...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RefrigeratorMalfunction.reported_by'
        db.add_column('malawi_refrigeratormalfunction', 'reported_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['rapidsms.Contact']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RefrigeratorMalfunction.reported_by'
        db.delete_column('malawi_refrigeratormalfunction', 'reported_by_id')
