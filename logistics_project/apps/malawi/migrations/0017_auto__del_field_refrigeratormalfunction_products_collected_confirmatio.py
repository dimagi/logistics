...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RefrigeratorMalfunction.products_collected_confirmation_received_on'
        db.delete_column('malawi_refrigeratormalfunction', 'products_collected_confirmation_received_on')


    def backwards(self, orm):
        # Adding field 'RefrigeratorMalfunction.products_collected_confirmation_received_on'
        db.add_column('malawi_refrigeratormalfunction', 'products_collected_confirmation_received_on',
