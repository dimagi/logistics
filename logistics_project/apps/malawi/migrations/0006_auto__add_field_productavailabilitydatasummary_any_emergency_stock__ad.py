...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductAvailabilityDataSummary.any_emergency_stock'
        db.add_column('malawi_productavailabilitydatasummary', 'any_emergency_stock',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProductAvailabilityData.emergency_stock'
        db.add_column('malawi_productavailabilitydata', 'emergency_stock',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProductAvailabilityData.managed_and_emergency_stock'
        db.add_column('malawi_productavailabilitydata', 'managed_and_emergency_stock',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductAvailabilityDataSummary.any_emergency_stock'
        db.delete_column('malawi_productavailabilitydatasummary', 'any_emergency_stock')

        # Deleting field 'ProductAvailabilityData.emergency_stock'
        db.delete_column('malawi_productavailabilitydata', 'emergency_stock')

        # Deleting field 'ProductAvailabilityData.managed_and_emergency_stock'
        db.delete_column('malawi_productavailabilitydata', 'managed_and_emergency_stock')
