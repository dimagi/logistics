...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductAvailabilityDataSummary.base_level'
        db.add_column('malawi_productavailabilitydatasummary', 'base_level',
                      self.gf('django.db.models.fields.CharField')(default='h', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductAvailabilityDataSummary.base_level'
        db.delete_column('malawi_productavailabilitydatasummary', 'base_level')
