    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reported_by', models.ForeignKey(on_delete=models.CASCADE, related_name='+', to='rapidsms.Contact')),
                ('sent_to', models.ForeignKey(on_delete=models.CASCADE, related_name='+', to='logistics.SupplyPoint', null=True)),
                ('supply_point', models.ForeignKey(on_delete=models.CASCADE, related_name='+', to='logistics.SupplyPoint')),
            ],
            options={
            },
            bases=(models.Model,),
