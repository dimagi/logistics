...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RefrigeratorMalfunction'
        db.create_table('malawi_refrigeratormalfunction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('supply_point', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['logistics.SupplyPoint'])),
            ('reported_on', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('malfunction_reason', self.gf('django.db.models.fields.CharField')(max_length=1)),
    ...
    def backwards(self, orm):
        # Deleting model 'RefrigeratorMalfunction'
        db.delete_table('malawi_refrigeratormalfunction')
