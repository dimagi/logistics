...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Consumption.time_with_data'
        db.add_column('malawi_consumption', 'time_with_data',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Consumption.time_needing_data'
        db.add_column('malawi_consumption', 'time_needing_data',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Consumption.time_with_data'
        db.delete_column('malawi_consumption', 'time_with_data')

        # Deleting field 'Consumption.time_needing_data'
        db.delete_column('malawi_consumption', 'time_needing_data')
