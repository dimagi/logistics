...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('malawi_consumption', (
            ...
            ('calculated_consumption', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('time_stocked_out', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
        ))
        db.send_create_signal('malawi', ['Consumption'])

    def backwards(self, orm):
        # Deleting model 'Consumption'
        db.delete_table('malawi_consumption')
