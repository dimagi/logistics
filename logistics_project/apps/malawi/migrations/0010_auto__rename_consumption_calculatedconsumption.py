...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming model 'Consumption'
        db.rename_table('malawi_consumption', 'malawi_calculatedconsumption')
        
        
    def backwards(self, orm):
        # Renaming model 'Consumption'
        db.rename_table('malawi_calculatedconsumption', 'malawi_consumption')
