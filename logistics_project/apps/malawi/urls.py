...
urlpatterns = patterns('',
    ...
    url(r'^management/permissions/$', "logistics_project.apps.malawi.views.permissions",
        name="malawi_permissions"),
    url(r'^management/places/$',
        "logistics_project.apps.malawi.views.places",
        name="malawi_places"),
    url(r'^management/places/upload/$',
        "logistics_project.apps.malawi.views.places_upload",
        name="malawi_places_upload"),
    url(r'^management/products/$',
        "logistics_project.apps.malawi.views.products",
        name="malawi_products"),
    url(r'^management/products/upload/$',
        "logistics_project.apps.malawi.views.products_upload",
        name="malawi_products_upload"),
