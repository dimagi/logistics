...
urlpatterns = patterns('',
    ...
    url(r'^facilities_by_products/?$',
        'logistics_project.apps.ewsghana.views.facilities_by_products',
        name="ewsghana_facilities_by_products"),
    url(r'^facility?$',
    ...
    url(r'^medical_stores/?$',
        ...
        name="medical_stores"),
    url(r'^district/(?P<code>\w+)/edit/?$',
       'logistics_project.apps.ewsghana.views.district', 
       { 'template': "ewsghana/config.html"},
       name='district_edit'),
    url(r'^district/?$',
       'logistics_project.apps.ewsghana.views.district', 
