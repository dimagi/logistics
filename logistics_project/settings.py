...
TEMPLATE_CONTEXT_PROCESSORS = [
    ...
    "logistics_project.context_processors.custom_settings",
    "logistics_project.context_processors.google_analytics",
...
LOGISTICS_ALERT_GENERATORS = ['logistics_project.apps.alerts.alerts.empty']
