...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogisticsProfile.date_updated'
        db.add_column('logistics_logisticsprofile', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 12, 21, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogisticsProfile.date_updated'
        db.delete_column('logistics_logisticsprofile', 'date_updated')
    ...
    models = {
        ...
        'logistics.supplypoint': {
            ...
            'closest_supply_points': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'closest_supply_points_rel_+'", 'blank': 'True', 'to': "orm['logistics.SupplyPoint']"}),
