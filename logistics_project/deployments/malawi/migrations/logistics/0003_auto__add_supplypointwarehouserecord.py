...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('logistics_supplypointwarehouserecord', (
        ...
        db.send_create_signal('logistics', ['SupplyPointWarehouseRecord'])

    def backwards(self, orm):
        # Deleting model 'SupplyPointWarehouseRecord'
        db.delete_table('logistics_supplypointwarehouserecord')
