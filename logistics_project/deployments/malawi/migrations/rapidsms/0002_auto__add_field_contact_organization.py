...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.organization'
        db.add_column('rapidsms_contact', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['malawi.Organization'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Contact.organization'
        db.delete_column('rapidsms_contact', 'organization_id')
