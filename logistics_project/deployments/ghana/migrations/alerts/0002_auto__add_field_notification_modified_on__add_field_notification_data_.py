...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notification.modified_on'
        db.add_column('alerts_notification', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 11, 30), blank=True), keep_default=False)

        # Adding field 'Notification.data_json'
        db.add_column('alerts_notification', 'data_json', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notification.modified_on'
        db.delete_column('alerts_notification', 'modified_on')

        # Deleting field 'Notification.data_json'
        db.delete_column('alerts_notification', 'data_json')
