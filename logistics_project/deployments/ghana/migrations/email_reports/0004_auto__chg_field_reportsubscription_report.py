...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReportSubscription.report'
        db.alter_column('email_reports_reportsubscription', 'report_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['email_reports.SchedulableReport']))


    def backwards(self, orm):
        
        # Changing field 'ReportSubscription.report'
        db.alter_column('email_reports_reportsubscription', 'report_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['email_reports.SchedulableReport'], null=True))
