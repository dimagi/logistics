...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MonthlyReportSubscription'
        db.create_table('email_reports_monthlyreportsubscription', (
        ...
        db.send_create_signal('email_reports', ['MonthlyReportSubscription'])


    def backwards(self, orm):
        
        # Deleting model 'MonthlyReportSubscription'
        db.delete_table('email_reports_monthlyreportsubscription')
