...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('email_reports_reportsubscription', 'reportfk_id', 'report_id')
        # 5 make the new one required
        db.alter_column('email_reports_reportsubscription', 'report_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['email_reports.SchedulableReport'], null=False))

        # Adding index on 'ReportSubscription', fields ['report']
        db.create_index('email_reports_reportsubscription', ['report_id'])
    ...
    models = {
        ...
        'email_reports.reportsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['email_reports.SchedulableReport']", 'null': 'True'}),
