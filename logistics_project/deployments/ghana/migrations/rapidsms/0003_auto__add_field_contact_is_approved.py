...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.is_approved'
        db.add_column('rapidsms_contact', 'is_approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.is_approved'
        db.delete_column('rapidsms_contact', 'is_approved')
