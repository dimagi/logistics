...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact._default_connection'
        db.add_column('rapidsms_contact', '_default_connection', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contact+', null=True, to=orm['rapidsms.Connection']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact._default_connection'
        db.delete_column('rapidsms_contact', '_default_connection_id')
