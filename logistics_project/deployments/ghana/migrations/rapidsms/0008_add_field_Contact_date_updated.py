...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.date_updated'
        db.add_column('rapidsms_contact', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 5, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.date_updated'
        db.delete_column('rapidsms_contact', 'date_updated')
    ...
    models = {
        ...
        'locations.location': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rapidsms.contact': {
            ...
            '_default_connection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'contact+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['rapidsms.Connection']"}),
