...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Connection.to'
        db.add_column('rapidsms_connection', 'to', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Connection.to'
        db.delete_column('rapidsms_connection', 'to')
