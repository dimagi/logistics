...
class Migration(DataMigration):
    def forwards(self, orm):
        ...
        _rename("logistics.apps.ewsghana.schedule.first_soh_reminder", 
                "logistics_project.apps.ewsghana.schedule.first_soh_reminder")
        _rename("logistics.apps.ewsghana.schedule.second_soh_reminder", 
                "logistics_project.apps.ewsghana.schedule.second_soh_reminder")
        _rename("logistics.apps.ewsghana.schedule.third_soh_to_super", 
                "logistics_project.apps.ewsghana.schedule.third_soh_to_super")
        _rename("logistics.apps.ewsghana.schedule.reminder_to_submit_RRIRV", 
