...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StockRequest.balance'
        db.add_column('logistics_stockrequest', 'balance', self.gf('django.db.models.fields.IntegerField')(default=None, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StockRequest.balance'
        db.delete_column('logistics_stockrequest', 'balance')
