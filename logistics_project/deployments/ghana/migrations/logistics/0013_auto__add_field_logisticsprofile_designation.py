...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LogisticsProfile.designation'
        db.add_column('logistics_logisticsprofile', 'designation', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LogisticsProfile.designation'
        db.delete_column('logistics_logisticsprofile', 'designation')
