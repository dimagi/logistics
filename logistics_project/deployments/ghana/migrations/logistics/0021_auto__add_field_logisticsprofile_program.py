...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LogisticsProfile.program'
        db.add_column('logistics_logisticsprofile', 'program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logistics.ProductType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LogisticsProfile.program'
        db.delete_column('logistics_logisticsprofile', 'program_id')
