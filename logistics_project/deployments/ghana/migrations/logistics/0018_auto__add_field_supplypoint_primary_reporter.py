...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SupplyPoint.primary_reporter'
        db.add_column('logistics_supplypoint', 'primary_reporter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SupplyPoint.primary_reporter'
        db.delete_column('logistics_supplypoint', 'primary_reporter_id')
