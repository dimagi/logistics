...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ilsgateway_product', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('units', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sms_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('msd_code', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('ilsgateway', ['Product'])


    def backwards(self, orm):
        
        # Deleting model 'Product'
        db.delete_table('ilsgateway_product')
