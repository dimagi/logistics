...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MinistryOfHealth'
        db.create_table('ilsgateway_ministryofhealth', (
        ...
        db.send_create_signal('ilsgateway', ['MinistryOfHealth'])


    def backwards(self, orm):
        
        # Deleting model 'MinistryOfHealth'
        db.delete_table('ilsgateway_ministryofhealth')
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 1, 10, 43, 38, 237000)', 'auto_now_add': 'True', 'blank': 'True'}),
