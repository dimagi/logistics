...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ILSGatewayUser'
        db.create_table('ilsgateway_ilsgatewayuser', (
        ...
        db.send_create_signal('ilsgateway', ['ILSGatewayUser'])


    def backwards(self, orm):
        
        # Deleting model 'ILSGatewayUser'
        db.delete_table('ilsgateway_ilsgatewayuser')
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointdgreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 18, 10, 46, 36, 531320)', 'auto_now_add': 'True', 'blank': 'True'}),
            'service_delivery_point': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.ServiceDeliveryPoint']"})
        },
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.Product']"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {}),
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 18, 10, 46, 36, 530379)', 'auto_now_add': 'True', 'blank': 'True'}),
