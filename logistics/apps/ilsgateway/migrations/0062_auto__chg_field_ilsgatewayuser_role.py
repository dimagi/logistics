...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ILSGatewayUser.role'
        db.alter_column('ilsgateway_ilsgatewayuser', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.ContactRole']))


    def backwards(self, orm):
        
        # Changing field 'ILSGatewayUser.role'
        db.alter_column('ilsgateway_ilsgatewayuser', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.ContactRole'], null=True))
    ...
    models = {
        ...
        'ilsgateway.ilsgatewayuser': {
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.ContactRole']"}),
            'service_delivery_point': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.ServiceDeliveryPoint']"}),
        ...
        'ilsgateway.servicedeliverypointdgreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 18, 15, 16, 22, 347302)', 'auto_now_add': 'True', 'blank': 'True'}),
            'service_delivery_point': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.ServiceDeliveryPoint']"})
        },
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ilsgateway.Product']"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {}),
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 18, 15, 16, 22, 346309)', 'auto_now_add': 'True', 'blank': 'True'}),
