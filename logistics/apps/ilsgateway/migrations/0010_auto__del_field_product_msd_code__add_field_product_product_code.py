...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.msd_code'
        db.delete_column('ilsgateway_product', 'msd_code')

        # Adding field 'Product.product_code'
        db.add_column('ilsgateway_product', 'product_code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Product.msd_code'
        db.add_column('ilsgateway_product', 'msd_code', self.gf('django.db.models.fields.CharField')(default='none', max_length=100), keep_default=False)

        # Deleting field 'Product.product_code'
        db.delete_column('ilsgateway_product', 'product_code')
