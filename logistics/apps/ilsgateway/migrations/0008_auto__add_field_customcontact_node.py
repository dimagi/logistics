...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomContact.node'
        db.add_column('ilsgateway_customcontact', 'node', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ilsgateway.Node'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomContact.node'
        db.delete_column('ilsgateway_customcontact', 'node_id')
