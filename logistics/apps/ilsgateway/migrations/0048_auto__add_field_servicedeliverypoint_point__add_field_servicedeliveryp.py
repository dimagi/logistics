...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ServiceDeliveryPoint.point'
        db.add_column('ilsgateway_servicedeliverypoint', 'point', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Point'], null=True, blank=True), keep_default=False)

        # Adding field 'ServiceDeliveryPoint.parent_type'
        db.add_column('ilsgateway_servicedeliverypoint', 'parent_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True), keep_default=False)

        # Adding field 'ServiceDeliveryPoint.parent_id'
        db.add_column('ilsgateway_servicedeliverypoint', 'parent_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ServiceDeliveryPoint.point'
        db.delete_column('ilsgateway_servicedeliverypoint', 'point_id')

        # Deleting field 'ServiceDeliveryPoint.parent_type'
        db.delete_column('ilsgateway_servicedeliverypoint', 'parent_type_id')

        # Deleting field 'ServiceDeliveryPoint.parent_id'
        db.delete_column('ilsgateway_servicedeliverypoint', 'parent_id')
    ...
    models = {
        ...
        'ilsgateway.servicedeliverypointproductreport': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 30, 18, 34, 14, 801000)', 'auto_now_add': 'True', 'blank': 'True'}),
