...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactDetail.contact'
        db.alter_column('ilsgateway_contactdetail', 'contact_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rapidsms.Contact'], unique=True))

        # Adding unique constraint on 'ContactDetail', fields ['contact']
        db.create_unique('ilsgateway_contactdetail', ['contact_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ContactDetail', fields ['contact']
        db.delete_unique('ilsgateway_contactdetail', ['contact_id'])

        # Changing field 'ContactDetail.contact'
        db.alter_column('ilsgateway_contactdetail', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact']))
