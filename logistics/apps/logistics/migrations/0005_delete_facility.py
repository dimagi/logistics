...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductStock.manual_monthly_consumption'
        db.delete_column('logistics_productstock', 'manual_monthly_consumption')

        # Deleting field 'ProductStock.auto_monthly_consumption'
        db.delete_column('logistics_productstock', 'auto_monthly_consumption')

        # Deleting field 'ProductStock.use_auto_consumption'
        db.delete_column('logistics_productstock', 'use_auto_consumption')
