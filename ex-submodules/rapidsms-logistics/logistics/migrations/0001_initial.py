    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(on_delete=models.CASCADE, blank=True, to='locations.Location', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.ForeignKey(on_delete=models.CASCADE, blank=True, to='messagelog.Message', null=True)),
                ('product', models.ForeignKey(on_delete=models.CASCADE, to='logistics.Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('canceled_for', models.ForeignKey(on_delete=models.CASCADE, to='logistics.StockRequest', null=True)),
                ('product', models.ForeignKey(on_delete=models.CASCADE, to='logistics.Product')),
                ('received_by', models.ForeignKey(on_delete=models.CASCADE, related_name='received_by', to='rapidsms.Contact', null=True)),
                ('requested_by', models.ForeignKey(on_delete=models.CASCADE, related_name='requested_by', to='rapidsms.Contact', null=True)),
                ('responded_by', models.ForeignKey(on_delete=models.CASCADE, related_name='responded_by', to='rapidsms.Contact', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=models.CASCADE, to='logistics.Product')),
                ('product_report', models.ForeignKey(on_delete=models.CASCADE, to='logistics.ProductReport', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supply_point', models.ForeignKey(on_delete=models.CASCADE, to='logistics.SupplyPoint')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='supplypoint',
            name='location',
            field=models.ForeignKey(on_delete=models.CASCADE, to='locations.Location'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='supplypoint',
        ...
        migrations.AddField(
            model_name='supplypoint',
            name='type',
            field=models.ForeignKey(on_delete=models.CASCADE, to='logistics.SupplyPointType'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='stocktransfer',
            name='giver',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='giver', blank=True, to='logistics.SupplyPoint', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='stocktransfer',
            name='product',
            field=models.ForeignKey(on_delete=models.CASCADE, to='logistics.Product'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='stocktransfer',
            name='receiver',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='receiver', to='logistics.SupplyPoint'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='stocktransaction',
            name='supply_point',
            field=models.ForeignKey(on_delete=models.CASCADE, to='logistics.SupplyPoint'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='report_type',
            field=models.ForeignKey(on_delete=models.CASCADE, to='logistics.ProductReportType'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='productreport',
        ...
        migrations.AddField(
            model_name='product',
            name='type',
            field=models.ForeignKey(on_delete=models.CASCADE, to='logistics.ProductType'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='logisticsprofile',
            name='user',
            field=models.ForeignKey(on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL, unique=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='historicalstockcache',
            name='product',
            field=models.ForeignKey(on_delete=models.CASCADE, to='logistics.Product', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='historicalstockcache',
