...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # 1 LogisticsProfile
        db.add_column('logistics_logisticsprofile', 'supply_point', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['logistics.SupplyPoint']), keep_default=False)
        # 2 rapidsms.Contact
        db.add_column('rapidsms_contact', 'supply_point', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['logistics.SupplyPoint']), keep_default=False)
        # 3 productreport
        ...
        # 5 stocktransaction
        db.add_column('logistics_stocktransaction', 'supply_point', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['logistics.SupplyPoint']), keep_default=False)
        # 6 productstock
        db.add_column('logistics_productstock', 'supply_point', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['logistics.SupplyPoint']), keep_default=False)
